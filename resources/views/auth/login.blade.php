            ...
            <div class="login_form_wrapper m-10">
                ...
                <div class="bg-white border p-5 rounded shadow-2xl form--login-width">
                    ...
                    <form action="{{ route('post.login') }}" method="post" class="form--grid">
                        ...
                        <div class="my-2">
                            <button type="submit" class="bg-blue-500 border p-2 pl-5 pr-5 rounded text-white uppercase">Login</button>
                            <a href="{{ route('get.signup.form') }}" class="bg-orange-400 border p-2 pl-5 pr-5 rounded text-white uppercase" style="padding: 9px;">Sign Up</a>
                        </div>
                    </form>
                </div>
            </div>
